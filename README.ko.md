...
이 프로젝트는 공군 복무 중 봤던 항공기 감시 지도에서 영감을 받았습니다. 국가 주변에 떠 있는 항공기들을 실시간으로 보여주는 화면이 인상적이었습니다. *지금 우리 하늘에는 뭐가 떠 있을까* 라는 시각이 계속 마음에 남았습니다. 시간이 한참 지나, 밤에 산책하다가 머리 위에서 반짝이는 점들을 봤는데, 대부분 위성이었습니다. 인터넷에 찾아보니 3D 지구본에 위성을 띄운 사이트나 위성 하나하나의 궤도를 보여주는 도구는 있었지만, *지금 우리나라 위에 어떤 위성이 있는지* 알려주는 곳은 없었습니다. 위성 발사가 빠르게 늘고 있는 시기였고, 이 빈자리를 직접 채워보고 싶어 만들게 됐습니다.
