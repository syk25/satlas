...
시작은 개인적이었다. 공군에서 항공기 감시 지도를 다뤘는데, 국가 주변 항공기 거동을 실시간으로 보여주는 화면이 인상 깊었다. *지금 우리 영공 위로 무엇이 떠 있는가* 라는 관점이 머릿속에 남았다. 시간이 지나 밤 산책 중에 머리 위에서 반짝이는 점들을 봤다. 대부분 위성이었다. 인터넷에 찾아보니 3차원 지구본에 위성을 배치한 도구나 2차원에서 위성 하나하나의 궤도를 추적하는 도구는 있었지만, 같은 관점을 위성에 적용한 곳은 없었다 — *국가 기준으로 지금 어떤 위성이 이 나라 위에 있는지*. 최근 위성 발사가 빠르게 늘면서 이 빈자리를 채워볼 만하다고 생각했다.
